...
# ==========================================
# Nota: Se sei su Streamlit Cloud, il file SQLite locale verrà comunque resettato 
# in caso di standby/riavvio. Per evitarlo definitivamente, considera l'uso 
# di un database cloud (es. Supabase/PostgreSQL) o Google Sheets.
...
# Apriamo la sessione del database
session = Session()
...
try:
    ...
    # Garantisce la chiusura pulita della sessione in ogni circostanza
    session.close()
